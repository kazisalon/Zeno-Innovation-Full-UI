		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="text-center">
				...
				<p class="mt-4 text-xl text-gray-600">
					Comprehensive solutions for your technological needs
				</p>
			</div>
			...
			<div class="mt-20 grid grid-cols-1 gap-8 md:grid-cols-3">
				...
				>
					<div
						class="w-12 h-12 bg-indigo-500 rounded-md flex items-center justify-center"
					>
						<svg class="w-6 h-6 text-white" v-html="service.icon"></svg>
					</div>
		...
		return {
			services: [
				...
				},
				{
					title: "AI Solutions",
					description:
						"Intelligent systems powered by cutting-edge AI technology.",
