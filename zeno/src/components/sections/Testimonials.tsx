          ...
          >
            ...
            >
              <div className="flex items-center gap-x-4 mb-4">
                ...
                {/* Company logo placeholder */}                import { useState, useRef, useEffect } from 'react';
              ...
              export default Testimonials;
              <StarRating animate={true} />              import { useState, useRef, useEffect } from 'react';
              import { motion, useAnimation } from 'framer-motion';
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                      ...
                      >
                        <motion.div
                          ...
                          className="w-full"
                        >
                          <div className="relative group bg-gradient-to-br from-primary/80 to-accent/10 rounded-2xl p-8 shadow-lg">
                            <div className="flex items-center gap-x-4 mb-4">
                              <img
                                className="h-12 w-12 rounded-full bg-accent-light/10"
                                src={testimonials[current].image}
                                alt={testimonials[current].author}
                                onError={(e) => (e.currentTarget.src = '/fallback-image.png')}
                              />
                            ...
                            <p className="text-base leading-7 text-gray-300 mt-6">
                              "{testimonials[current].content}"
                            </p>
                          </div>
                        </motion.div>
                        ...
                        <div className="flex gap-2 mt-6">
                          {testimonials.map((_, idx) => (
                            <button
                              key={idx}
                              className={`w-3 h-3 rounded-full border-2 ${current === idx ? 'bg-accent-light border-accent-light' : 'bg-gray-700 border-gray-500'}`}
                              onClick={() => setCurrent(idx)}
                              aria-label={`Go to testimonial ${idx + 1}`}
                              aria-current={current === idx ? 'true' : 'false'}
                            />
