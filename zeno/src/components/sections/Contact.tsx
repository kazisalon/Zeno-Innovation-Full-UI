            ...
            <form className="relative p-8">
                ...
                <div>
                  ...
                  <div className="mt-2.5">
                    <input
                      ...
                      className="block w-full rounded-md border-0 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-accent-light sm:text-sm sm:leading-6 bg-white/5 backdrop-blur-sm"
                    />
                  </div>
                </div>
                <div>
              ...
              <div className="mt-10">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="block w-full rounded-md bg-gradient-to-r from-accent-light to-accent px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:shadow-[0_8px_32px_rgba(var(--accent-light-rgb),0.4),0_0_16px_rgba(var(--accent-light-rgb),0.6)] transition-all duration-300"
                >
                  Send Message
                </motion.button>
              </div>
