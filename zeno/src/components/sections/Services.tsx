      ...
      <div className="mx-auto max-w-7xl relative px-6 lg:px-8">
        ...
        >
          <motion.h2
            ...
            className="text-3xl font-bold tracking-tight sm:text-4xl bg-gradient-to-r from-blue-400 via-accent-light to-blue-600 bg-clip-text text-transparent animate-gradient hover-scale [text-shadow:0_4px_8px_rgba(var(--accent-light-rgb),0.2)]"
          >
            Our Services
          </motion.h2>
          <motion.p
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative glass-effect rounded-xl p-6 border border-white/25 group-hover:border-accent/60 transition-all duration-500 cyberpunk-border shadow-lg group-hover:shadow-accent/30">
                ...
                <div className="relative">
                  <motion.div
                    ...
                    className="w-12 h-12 rounded-lg bg-gradient-to-r from-accent-light/40 to-accent/40 flex items-center justify-center group-hover:from-accent-light/60 group-hover:to-accent/60 transition-all duration-300 pulse-glow shadow-lg group-hover:shadow-accent/40"
                  >
